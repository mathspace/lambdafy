...
const (
	...
	specInEnvLogGroupRetentionDays = specInEnvPrefix + "LOG_GROUP_RETENTION_DAYS"
)
...
func publish(specReader io.Reader, vars map[string]string) (res publishResult, err error) {
	...
	spec.Env[specInEnvLogGroupRetentionDays] = strconv.FormatInt(int64(*spec.LogGroupRetentionDays), 10)
